...
export const MOCK_POSTS: Post[] = [
  {
    id: 1,
    user: { id: 1, display_name: "Yuki", icon_url: null },
    slides: [
      {
        image_url:
      ...
      {
        image_url:
          "https://images.unsplash.com/photo-1544378730-8b5104b18790?w=400&h=600&fit=crop",
        text: "煙の量がえぐい！！",
  ...
  {
    id: 2,
    user: { id: 2, display_name: "Hana", icon_url: null },
    slides: [
      {
        image_url:
  ...
  {
    id: 3,
    user: { id: 3, display_name: "Sora", icon_url: null },
    slides: [
      {
        image_url:
  ...
  {
    id: 4,
    user: { id: 4, display_name: "Riku", icon_url: null },
    slides: [
      {
        image_url:
  ...
  {
    id: 5,
    user: { id: 5, display_name: "Mio", icon_url: null },
    slides: [
      {
        image_url:
          "https://images.unsplash.com/photo-1543353071-873f17a7a088?w=400&h=600&fit=crop",
  ...
  {
    id: 6,
    user: { id: 6, display_name: "Ao", icon_url: null },
    slides: [
      {
        image_url:
