...
INSERT INTO slides (post_id, image_url, text, flavor_id, slide_order) VALUES
  ...
  (1, '/images/264973_0.jpg', '最後はレモン。締めにぴったり', 3, 2);

-- Post 2: 2つのスライド (flavor_id: 4=マンゴー, 5=オレンジ)
INSERT INTO slides (post_id, image_url, text, flavor_id, slide_order) VALUES
  (2, '/images/264974_0.jpg', 'グレープの濃厚な香り', 4, 0),
...
-- Post 4: 2つのスライド (flavor_id: 6=グレープ, 1=ミント)
INSERT INTO slides (post_id, image_url, text, flavor_id, slide_order) VALUES
  (4, '/images/264978_0.jpg', 'マンゴーで夏気分', 6, 0),
...
-- Post 6: 2つのスライド (flavor_id: 4=マンゴー, 3=ベリー)
INSERT INTO slides (post_id, image_url, text, flavor_id, slide_order) VALUES
  (6, '/images/264976_0.jpg', 'グレープで濃厚な一服', 4, 0),
  (6, '/images/264977_0.jpg', 'レモンでさっぱり', 3, 1);
